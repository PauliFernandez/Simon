...
function EsAlfanumerico(Cadena) {
    ...
    for (var i = 0, Tamaño = Cadena.length; i < Tamaño; i++) {
      ...
      if (!(CodigoLetra > 47 && CodigoLetra < 58) && // Numero (0-9)
          !(CodigoLetra > 64 && CodigoLetra < 91) && // Letras Mayusculas (A-Z)
          !(CodigoLetra > 96 && CodigoLetra < 123)) { // Letras Minusculas (a-z)
        return false;
      }
    }
...
function CorreoValido(Correo) {
    ...
    return (PosicionArroba < PosicionUltimoPunto && PosicionArroba > 0 && Correo.indexOf('@@') == -1 && PosicionUltimoPunto > 2 && (Correo.length - PosicionUltimoPunto) > 2);
}
